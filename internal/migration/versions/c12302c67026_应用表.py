...
Revision ID: c12302c67026
Revises: 309352ed9e01
Create Date: 2025-03-03 10:10:10.147040
...
revision = 'c12302c67026'
down_revision = '309352ed9e01'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('app', schema=None) as batch_op:
        batch_op.add_column(sa.Column('a_id', sa.UUID(), server_default=sa.text('uuid_generate_v4()'), autoincrement=False, nullable=False))
