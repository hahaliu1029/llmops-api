...
Revision ID: 527d85b8f94f
Revises: 292fecb9e47a
Create Date: 2025-02-13 15:33:13.499889
...
revision = '527d85b8f94f'
down_revision = '292fecb9e47a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('provider_id', sa.UUID(), server_default=sa.text('uuid_generate_v4()'), nullable=False),
