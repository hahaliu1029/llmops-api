...
Revision ID: 9984bbf806c3
Revises: 
Create Date: 2025-01-17 10:47:42.461873
...
def downgrade():
    ...
    sa.Column('demo', sa.VARCHAR(length=255), autoincrement=False, nullable=True)
    )
    with op.batch_alter_table('app', schema=None) as batch_op:
